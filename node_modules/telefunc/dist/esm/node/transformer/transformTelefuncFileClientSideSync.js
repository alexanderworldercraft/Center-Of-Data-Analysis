...
function transformTelefuncFileClientSideSync(id, appRootDir, exportNames) {
    ...
    assertUsage(!telefuncFilePath.startsWith('../'), `The telefunc file ${telefuncFilePath} needs to live inside ${appRootDir} (the client-side root directory, i.e. the root directory of Vite/Vike/Next.js/Nuxt/...)`);
...
export function getCode(exportNames, telefuncFilePath) {
    const lines = [];
