...
const errorPrefix = `[telefunc@${projectInfo_1.projectInfo.projectVersion}]`;
...
function getProjectError(errorMessage) {
    ...
    const pluginError = (0, createErrorWithCleanStackTrace_1.createErrorWithCleanStackTrace)(`${errorPrefix}${sep}${errorMessage}`, numberOfStackTraceLinesToRemove);
    return pluginError;
}
const globalObject = (0, getGlobalObject_1.getGlobalObject)('assert.ts', { alreadyLogged: new Set() });
