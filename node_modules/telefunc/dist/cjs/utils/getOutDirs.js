...
exports.getOutDirAbsolute = getOutDirAbsolute;
...
function determineOutDir(config) {
    ...
    if (config.plugins.some((p) => { var _a; return (_a = p.name) === null || _a === void 0 ? void 0 : _a.startsWith('astro:'); }))
        return null;
    const outDirRoot = (0, filesystemPathHandling_1.toPosixPath)(config.build.outDir);
...
function getOutDirAbsolute(config) {
    ...
    outDir = (0, filesystemPathHandling_1.toPosixPath)(outDir);
    if (!outDirIsAbsolutePath(outDir)) {
        const { root } = config;
        (0, filesystemPathHandling_1.assertPosixPath)(root);
        outDir = (0, path_shim_js_1.pathJoin)(root, outDir);
    }
    return outDir;
}
